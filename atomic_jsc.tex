...
% Maths
\usepackage{amssymb,stmaryrd,amsthm,amsmath,thmtools} %thmtools fixes the cleveref error
...
\input{src/intro_resub.tex}
%\input{src/intro.tex}
%\input{src/preliminaries_resub.tex}
\input{src/equiv_ideals}
\input{src/hbp.tex}
\input{src/equiv_gb.tex}
%\input{src/preliminaries.tex}
%\input{src/egb_resub.tex}

...
% Knowledge logo
\newcommand{\klogo}{%
\begin{tikzpicture}[scale=0.3,line/.style={draw, line width=1pt, line cap=round, line join=round}]
\coordinate (A00) at (0,0);
\coordinate (A01) at (0,1);
\coordinate (A10) at (1,0);
\coordinate (B10) at (1,0.2);
\coordinate (B01) at (0.2,1);
\coordinate (C01) at (0.3,0.7);
\coordinate (C10) at (0.7,0.3);
\coordinate (C12) at (0.7,1.1);
\coordinate (C21) at (1.1, 0.7);
\coordinate (C22) at (1.1, 1.1);

...
\newcommand{\spolyset}{\mathsf{SSet}}
...
\newcommand{\cmp}[1][]{\mathop{\mathsf{\widetilde{CM}}_{#1}}} % CM pair
\newcommand{\var}{\mathop{\mathsf{var}}}
\newcommand{\varin}[1]{\var_{\in #1}}
\newcommand{\varout}[1]{\var_{\notin #1}}
\newcommand{\width}{\mathsf{width}}

\newcommand{\lmdec}[1][]{\mathop{\mathsf{LM}_{#1}}}
\newcommand{\domdec}{\mathop{\mathsf{dom}}}
...
\NewDocumentCommand{\CancelPoly}{ m m }{\mathsf{C}_{#1,#2}}

%%%%%%%%%%%%%%%% "Colourful" macros %%%%%%%%%%%%%%%%%%

\newcommand{\forget}{\mathsf{forget}}
\newcommand{\col}{\mathsf{C}}
\newcommand{\paint}[1]{#1_{\col}}
\newcommand{\repaint}[1]{\alpha_{#1}}
\newcommand{\repL}{\, \triangleleft\, }
\newcommand{\repR}{\, \triangleright\, }

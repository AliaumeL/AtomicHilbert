...
\newcommand{\eqdivleq}{\gdivleq[eqv]}
...
\NewDocumentOrdering{colex}{\sqsubseteq^{\mathsf{CoLex}}}
{\sqsubset^{\mathsf{CoLex}}}
...
\NewDocumentCommand{\EqIdlGen}{ O{eqv} m }{\withkl{\kl[\EqIdlGen]}{
  \mathopen{\cmdkl{\langle}}
  #2 

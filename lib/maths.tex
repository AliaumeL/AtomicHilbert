...
\newcommand{\msubseteq}[1]{\subseteq_{#1}}
...
\NewDocumentCommand{\NewDocumentOrdering}{ m m m m m }{
    ...
    \expandafter\newcommand\csname #1geq\endcsname{
        \mathrel{\kl[#1]{#4}}
    }
    \expandafter\newcommand\csname #1gt\endcsname{
        \mathrel{\kl[#1]{#4}}
    }
    \knowledge{#1}{notion}
}
...
\NewDocumentOrdering{var}{\leq_{\Indets}}{<_{\Indets}}{\geq_{\Indets}}{>_{\Indets}}

\NewDocumentOrdering{mon}{\sqsubseteq}{\sqsubset}{\sqsupseteq}{\sqsupset}
\NewDocumentOrdering{lex}{\sqsubseteq_{\mathsf{Lex}}}{\sqsubset_{\mathsf{Lex}}}{\sqsupseteq_{\mathsf{Lex}}}{\sqsupset_{\mathsf{Lex}}}
%\NewDocumentOrdering{shortlex}{\sqsubseteq_{\mathsf{ShortLex}}}
\NewDocumentOrdering{revlex}{\sqsubseteq^{\mathsf{RevLex}}}{\sqsubset^{\mathsf{RevLex}}}{\sqsupseteq^{\mathsf{RevLex}}}{\sqsupset^{\mathsf{RevLex}}}
\NewDocumentOrdering{colex}{\sqsubseteq_{\mathsf{CoLex}}}{\sqsubset_{\mathsf{CoLex}}}{\sqsupseteq_{\mathsf{CoLex}}}{\sqsupset_{\mathsf{CoLex}}}
%\NewDocumentOrdering{glex}{\sqsubseteq_{\mathsf{GrLex}}}{\sqsubset_{\mathsf{GrLex}}}



\NewDocumentOrdering{pmon}{\preceq}{\prec}{\succeq}{\succ}
...
\newcommand{\monoid}{\mathcal{M}}
\newcommand{\grp}[1][G]{\mathcal{#1}}
\newcommand{\iden}[1][\monoid]{\mathbf{id}_{#1}}
...
\NewDocumentCommand{\redtr}{m}{
  \mathrel{\kl[\redtr]{\to^*_{#1}}}
}
\knowledge{\redtr}{notion}


\NewDocumentCommand{\redfun}{m}{
  \mathop{\kl[\redfun]{\textsc{reduce}_{#1}}}
}
\knowledge{\redfun}{notion}

...
\todo[inline]{No we did not write it. It in the good time to do so after your 
paragraph on homogeneous structures.}
...
which is the unique (up to isomorphism) homogeneous infinite tree such that every finite tree is isomorphic to a topological minor of $\T$ \arka{There are no edges!}
\arka{rewrite using meet-relation}.

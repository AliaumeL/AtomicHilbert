...
on finitely many indeterminates. The use of \kl{Gröbner bases} to compute
polynomial invariants of programs has been a recurring theme in computer
science, and did not wait for \kl{topological well-structured transition 
systems} to used in the verification of programs \cite{MULSEI02}, or more
...
problem} for \kl{topological well-structured transition systems}.

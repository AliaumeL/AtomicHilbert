...
Moreover, they are \intro{homogeneous}:
every isomorphisms between finite induced substructures extends to an automorphism of the whole structure (\arka{cite wikipedia and macpherson survey})
%

\arka{Homogenous? Since then we can list substructures, how they look labels}
...
However, $(\mon[\N \times \N]{\A}, \gdivleq)$ is a \kl{WQO}.
This is because $(\mon[\N \times \N]{\A}, \gdivleq[\aut{\A}])$ is essentially the ordering of finite multisets on $\N \times \N$ (\arka{cite MPRI lecture notes?}.

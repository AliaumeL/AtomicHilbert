...
\todo[inline]{aliaume: use König + say that the image is orbit finite}
\begin{lemma}
...
\todo[inline]{say that the output is orbit finite}
...
\todo[inline]{say we take orbit finite set as input}

...
\begin{lemma}
  ...
  The \cref{alg:weakgb} is a computable function that is itself \kl(func){equivariant},
  and produces an \kl{orbit finite} set $\Basis$ if it terminates.
  \kl(func){equivariant}, and produces an \kl{orbit finite} set $\Basis$ if it terminates.
\end{lemma}
%
\begin{proof}

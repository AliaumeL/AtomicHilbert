...
and the for ordered data this problem is known to be undecidable \cite[Proposition 1 and Section 5.2]{RODA11}.
\Cref{cor:rev data VAS} implies both of these become decidable when the Petri net is assumed to reversible.
\end{remark}
%

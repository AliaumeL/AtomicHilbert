...
\subsubsection{Polynomial computations.} \AP The fact that (finite control) systems
...
\subsubsection{Reachability problem of reversible data Petri nets.} The classical
...
\end{remark}
%
\subsubsection{Orbit-finite systems of equations} \AP The classical theory of

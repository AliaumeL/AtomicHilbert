...
\para{Structural operations.} Let us first focus on three standard
...
\para{Reducts and nicely orderable actions.} \AP Another important operation
...
\para{Polynomial computations.} \AP The fact that (finite control) systems
...
\para{Reachability problem of reversible data Petri nets.} The classical
...
\end{remark}
%
\para{Orbit-finite systems of equations} \AP The classical theory of

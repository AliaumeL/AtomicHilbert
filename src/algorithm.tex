...
\end{definition}
%
\arka{Can we use $\cmp$ instead of $\cmp$ (\Cref{def:cmp T f} here?}
%
\begin{lemma}
...
\arka{Maybe we should use $T$ instead of $S$ to avoid confusion with $\spoly{}{}$.}
...
\arka{I suggest splitting this into a lemma and a corollary, or simply two lemmas} 
\begin{lemma}

...
\arka{use the same notation in the intro?}
...
\arka{push later}
\begin{lemma}
The action $\inc{\OrderAtoms}\actson{\OrderAtoms}$ is \kl{nicely ordered}.
\end{lemma}
%
\begin{proof}
through an equivariant map from monomials to a wqo 
\end{proof}
%

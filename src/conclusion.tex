...
\subsection{Total orderings on the set of indeterminates} We assumed that the
...
of \kl{leading monomials} would no longer be well-defined without it. However,
...
\subsection{Complexity} In the present paper, we focused on the
...
the complexity of such problems, and adapted only the most basic
algorithms for computing \kl{Gröbner bases}. It would be interesting to know,
on the theoretical side, whether one can obtain complexity lower bounds for such
problems, but also on the more practical side whether advanced algorithms like
...
%
\subsection{Equivariant algebraic geometry} The development of \kl{equivariant

...
%
\AP An \kl{equivariant subset $S\subseteq \poly{\K}{\Indets}$} is said to be \intro{orbit finite} if it is the union of finitely many \intro{orbits} under the action of $\aut{\Indets}$.
...
%
We identify a tuple $(x_1,\dots,x_n)\in \Indets^n$ with the monomial $x_1 x_2^2 \dots x_n^{2^n} \in \mon{\Indets}$.
...
$\group \actson \X$ is said to be \intro(ord){compatible}

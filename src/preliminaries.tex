...
\arka{Variables are identified with elements from a rel str}

\AP A \intro{group} $\group$ is a set equipped with a binary operation that is
...
\arka{add the homomorphism part}

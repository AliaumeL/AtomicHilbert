...
\intro{group action} $\group \actson \X$.
This means that $\group$ is a subgroup of bijections of the set $\Indets$ to itself.
A set $S \subseteq \X$ is \intro{equivariant} under the action of
...
Let us point out that the image of an \kl{orbit finite set} under
...
\group$ such that $\monelt_1$ \kl{divides} $\gelem(\monelt_2)$. This

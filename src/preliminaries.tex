...
\paragraph{Partial orders, ordinals, well-founded sets, and well-quasi-ordered sets.}
...
\paragraph{Ideals and Gröbner Bases.}
...
\paragraph{Group actions and equivariance} 
...
\paragraph{Computability assumptions.}

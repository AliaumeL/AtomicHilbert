...
For $T\subseteqfin\X$, a set $B\subseteq\poly{\K}{\X}$ is called a $T$-strong basis for an equivariant ideal $I\subseteqfin\poly{\K}{\X}$ if for all $f\in I$ there exists $b\in B$ such that $\lm[T](b)$ divides $\lm[T](f)$.

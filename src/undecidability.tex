...
\arka{Maybe boldface for structures and mathhbb for numeric sets}

\arka{How about putting the examples in the sections where we discuss structures}
...
\begin{proof}
  ...
  \arka{This does not guarantee that the encoding is valid}
  i.e., that we do not

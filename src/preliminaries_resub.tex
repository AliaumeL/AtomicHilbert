...
\item there exists an algorithm that takes elements $a_1,\dots,a_n\Indets$ as input and outputs a finite set $P$ such that $\setof{(y_1,\dots,y_n)}{y_k\in\orbit[\monoid]{x_k}} = \orbit[\group]{P}$.
\end{enumerate}
%
